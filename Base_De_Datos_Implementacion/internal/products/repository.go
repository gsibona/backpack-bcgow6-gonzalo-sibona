...
import (
	...
	"github.com/gsibona/backpack-bcgow6-gonzalo-sibona/Base_De_Datos_Implementacion/db"
	"github.com/gsibona/backpack-bcgow6-gonzalo-sibona/Base_De_Datos_Implementacion/pkg/models"
)

type Repository interface {
	Store(models.Product) (models.Product, error)
	GetOne(id int) models.Product
	GetOneByName(name string) models.Product
...
const (
	...
	GetProductByName 	= "SELECT * FROM products WHERE name LIKE ?"
...
func (r *repository) GetOneByName(name string) models.Product {
	var product models.Product
	db := db.StorageDB
